...
-- S	=>  Location: PIN_K7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Cin	=>  Location: PIN_F2,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \inst5~0_combout\ = (\A~input_o\ & ((\Cin~input_o\) # (\B~input_o\))) # (!\A~input_o\ & (\Cin~input_o\ & \B~input_o\))
...
-- Equation(s):
-- \inst|1~0_combout\ = \A~input_o\ $ (\Cin~input_o\ $ (\B~input_o\))
